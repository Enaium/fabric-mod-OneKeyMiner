    ...
    override fun execute(
        ...
        if (args[0].equals("limit", ignoreCase = true)) {
            if (args.size == 1) {
                ...
                ServerCommandCallbacks.LimitCallback.EVENT.invoker.execute(args[1].toInt())
        ...
        if (args[0].equals("interact", ignoreCase = true)) {
            if (args.size == 1) {
                ...
                ServerCommandCallbacks.InteractCallback.EVENT.invoker.execute(args[1].toBoolean())
        ...
        if (args[0].equals("hotkey", ignoreCase = true)) {
            if (args.size == 1) {
                ...
                ServerCommandCallbacks.HotkeyCallback.EVENT.invoker.execute(args[1].toBoolean())
                    ...
                    val block = LiteralText(name).setStyle(
                        Style().setHoverEvent(
                            HoverEvent(
                                ...
                                TranslatableText((Block.REGISTRY[Identifier(name)] as Block).translatedName)
                            )
                        )
                    )
                    if (previous == null) {
