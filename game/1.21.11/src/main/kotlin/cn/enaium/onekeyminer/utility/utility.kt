...
fun ServerPlayerEntity.toCommon(world: World): Player {
    return object : Player {
        ...
        override fun canMine(pos: cn.enaium.onekeyminer.common.BlockPos): Boolean {
            ...
            return this@toCommon.inventory.getStack(this@toCommon.inventory.selectedSlot)?.let { handStack ->
                handStack.item.canMine(
                    handStack,
        ...
        override val mainHandEmpty: Boolean
            get() = this@toCommon.inventory.mainStacks.isEmpty()
