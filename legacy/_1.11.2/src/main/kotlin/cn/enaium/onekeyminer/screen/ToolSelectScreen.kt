...
class ToolSelectScreen : Screen() {
    override fun init() {
        addButton(ButtonWidget(0, 0, 0, 200, 20, TranslatableText("button.axe").asFormattedString()))
        addButton(ButtonWidget(1, 0, 30, 200, 20, TranslatableText("button.hoe").asFormattedString()))
        addButton(ButtonWidget(2, 0, 60, 200, 20, TranslatableText("button.pickaxe").asFormattedString()))
        addButton(ButtonWidget(3, 0, 90, 200, 20, TranslatableText("button.shovel").asFormattedString()))
        addButton(ButtonWidget(4, 0, 120, 200, 20, TranslatableText("button.shears").asFormattedString()))
        addButton(ButtonWidget(5, 0, 150, 200, 20, TranslatableText("button.any").asFormattedString()))
        super.init()
    }
