...
fun interface UseOnBlockCallback {
    fun interact(player: PlayerEntity, world: World, stack: ItemStack, hand: Hand, hitResult: BlockHitResult)

    companion object {
        val EVENT = EventFactory.createArrayBacked(
            UseOnBlockCallback::class.java
        ) { listeners: Array<UseOnBlockCallback> ->
            UseOnBlockCallback { player: PlayerEntity, world: World, stack: ItemStack, hand: Hand, hitResult: BlockHitResult ->
